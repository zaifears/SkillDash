...
const FileUpload: React.FC<FileUploadProps> = ({ 
  ...
  const processFile = useCallback(async (file: File) => {
    ...
    try {
      ...
      // ✅ FIXED: Success - pass extracted text to parent (NOT analysis feedback)
      // The parent will show job-description step and deduct coins when user clicks Analyze
      onFileProcessed(result.extractedText, result.fileName || file.name)
