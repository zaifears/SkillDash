...
const TypingHeroSection = () => {
    return (
        <section className="hero-background-container relative py-16 sm:py-18 md:py-6 px-6 text-center overflow-hidden bg-cover bg-center bg-no-repeat min-h-[450px] sm:min-h-[550px] md:min-h-[700px] flex items-center justify-center" style={{
            ...
            <div className="max-w-6xl mx-auto relative z-10 py-6 sm:py-12 md:py-8 px-4 sm:px-6">
                ...
                <div className="relative mb-8 sm:mb-8 md:mb-10">
                    <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent leading-normal md:leading-relaxed transition-all duration-500 hover:scale-[1.02] cursor-default drop-shadow-sm">
                        Master the Markets
                    </h1>
                ...
                {/* Subtitle */}
                <p className="text-base sm:text-lg md:text-2xl text-gray-600 dark:text-gray-300 mb-10 sm:mb-12 md:mb-14 max-w-4xl mx-auto leading-relaxed px-2 font-medium">
                ...
                <div className="relative inline-block mb-12 sm:mb-16 md:mb-16">
                    ...
                    <Link 
                        href="/simulator" 
                        className="relative bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold py-4 sm:py-5 px-8 sm:px-10 rounded-full hover:scale-105 transform transition-all duration-300 inline-flex items-center gap-2 sm:gap-3 shadow-xl hover:shadow-blue-500/25 text-base sm:text-lg"
                    >
