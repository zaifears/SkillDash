  ...
  const handleCardClick = useCallback(() => {
    if (availableLanguages.length === 1) {
      ...
      if (course?.url) {
        ...
        if (course.url.includes('youtube.com') || course.url.includes('youtu.be')) {
          setSelectedVideoUrl(course.url);
  ...
  return (
    ...
    >
      ...
      {availableLanguages.length === 1 ? (
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-600/50 rounded-2xl p-4 border border-gray-200/50 dark:border-gray-600/50">
          <div className="flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              ...
              <button
                ...
                className="text-xs bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full font-medium transition-colors flex items-center justify-center gap-1.5 group/btn whitespace-nowrap flex-shrink-0"
              >
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-wide mb-1">Educator:</p>
              {(() => {
    ...
    <section className="py-16 px-6 lg:py-20">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-600 bg-clip-text text-transparent leading-tight tracking-tight mb-6">
            TEST YOUR
            <br />
            INTEREST
          </h1>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed mb-12">
            Discover your passion through hands-on learning. Each skill comes with carefully curated courses from expert educators in <strong>Bangla and English</strong> languages.
          </p>
