...
export const EyeOffIcon = React.memo(() => (
  <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <path d="M15.171 13.576l1.472 1.473a1 1 0 001.414-1.414l-14-14a1 1 0 00-1.414 1.414l1.473 1.473A10.014 10.014 0 00.458 10C1.732 14.057 5.522 17 10 17a9.958 9.958 0 004.512-1.074l1.78 1.781a1 1 0 001.414-1.414l-2.023-2.023z" />
  </svg>
));
