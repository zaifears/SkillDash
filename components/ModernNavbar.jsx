...
const ModernNavbar = () => {
  ...
  return (
    <>
      ...
      } lg:left-1/2 lg:right-auto lg:transform lg:-translate-x-1/2 lg:w-auto`}>
        {/* Different styling for mobile vs desktop */}
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border border-gray-200/50 dark:border-gray-700/50 rounded-full shadow-lg px-4 py-3 lg:px-8 lg:py-3 lg:min-w-max">
          <div className="flex items-center justify-between lg:justify-start lg:gap-6">
            {/* Logo - Always visible with both icon and text */}
            <Link href="/" className="flex items-center gap-2 text-lg font-bold text-gray-800 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors whitespace-nowrap">
              <img src="/skilldash-logo.png" alt="SkillDash" className="h-7 w-7 lg:h-7 lg:w-7" />
