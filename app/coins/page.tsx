...
const CoinsPage: React.FC = () => {
  ...
  return (
    <HRAccessBlock pageName="SkillCoins">
      ...
      <div className="px-4 py-6 max-w-5xl mx-auto">
            ...
            <form onSubmit={handleRechargeSubmit} className="space-y-6 sm:space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  min={minCoins}
                  max={maxCoins}
                  className="w-full px-4 sm:px-6 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-2xl sm:text-3xl font-bold text-center focus:ring-4 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  required
                />
              ...
              {requests.map((req) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-0 mb-2">
                    ...
                    <span
                      className={`px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-semibold self-start flex-shrink-0 ${
                        req.status === 'approved'
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg mb-6 sm:mb-8 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center text-xl sm:text-2xl shadow-lg flex-shrink-0">
              💡
            </div>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">How to Earn Coins</h2>
          </div>
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-xl p-3 sm:p-6 mb-4 sm:mb-6">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-xl sm:text-2xl shadow-lg flex-shrink-0">
                🎯
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mb-2">
                  <h3 className="font-bold text-green-800 dark:text-green-300 text-base sm:text-lg">Welcome Bonus</h3>
                  <span className="bg-green-500 text-white px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-bold flex items-center gap-1 self-start">
                    Already Issued ✅
                  </span>
                </div>
                <p className="text-green-700 dark:text-green-300 mb-2 sm:mb-3 text-xs sm:text-base">Get 5 coins when you create your account</p>
                <div className="text-xl sm:text-2xl font-bold text-green-600 dark:text-green-400">+5 coins</div>
              </div>
            </div>
          </div>
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-base sm:text-lg font-semibold text-gray-600 dark:text-gray-400 mb-3 sm:mb-4">Coming Soon</h3>
            <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl p-3 sm:p-4 opacity-75">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-200 dark:bg-gray-600 rounded-xl flex items-center justify-center text-lg sm:text-xl opacity-50 flex-shrink-0">
                  📅
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-1 sm:gap-2 mb-1">
                    <h4 className="font-semibold text-gray-600 dark:text-gray-300 text-sm sm:text-base">Daily Login</h4>
                    <span className="bg-gray-400 text-white px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-bold">SOON</span>
                  </div>
                  <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">+1 coin per day</p>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl p-3 sm:p-4 opacity-75">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-1 sm:gap-2 mb-1">
                    <h4 className="font-semibold text-gray-600 dark:text-gray-300 text-sm sm:text-base">Referrals</h4>
                    <span className="bg-gray-400 text-white px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-bold">SOON</span>
                  </div>
                  <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">+3 coins per friend</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg mb-6 sm:mb-8 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl flex items-center justify-center text-xl sm:text-2xl shadow-lg flex-shrink-0">
              🔥
            </div>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">SkillDash Features</h2>
          </div>
        ...
        {/* Transaction History */}
        <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-6 shadow-lg mb-6 sm:mb-8 border border-gray-200 dark:border-gray-700">
          <TransactionHistory />
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          <button
            onClick={() => router.push(ROUTES.RESUME_FEEDBACK)}
            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-medium text-sm sm:text-base transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2 sm:gap-3 shadow-lg"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span className="truncate">Analyze Resume ({LIMITS.COINS_PER_FEATURE} coin)</span>
          </button>
          
          <button
            onClick={() => router.push(ROUTES.DISCOVER)}
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-medium text-sm sm:text-base transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2 sm:gap-3 shadow-lg"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <span className="truncate">Discover Careers ({LIMITS.COINS_PER_FEATURE} coin)</span>
          </button>

          <button
            onClick={fetchCoinData}
            className="bg-gray-600 hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-medium text-sm sm:text-base transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2 sm:gap-3 shadow-lg sm:col-span-2 lg:col-span-1"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
