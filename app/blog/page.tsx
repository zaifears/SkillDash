...
export const metadata: Metadata = {
    title: 'Stock Simulator BD Blog | DSE Trading Guides and Insights',
    description:
        'Professional guides on Dhaka Stock Exchange investing, broker comparisons, and risk-free paper trading with Stock Simulator BD.',
    alternates: {
...
const posts = [
    {
        ...
        excerpt:
            'SkillDash has officially rebranded to Stock Simulator BD. Read our official strategic announcement regarding our 100% pivot into building the ultimate Dhaka Stock Exchange (DSE) paper trading terminal.',
    },
    {
